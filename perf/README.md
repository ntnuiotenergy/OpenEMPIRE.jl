...
The Julia runner also prints counts for every named JuMP constraint family,
even when performance reporting is disabled. This helps localize model-size
differences without changing default run artifacts.
